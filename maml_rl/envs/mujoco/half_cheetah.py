...
class HalfCheetahVelEnv(HalfCheetahEnv):
    ...
    """
    def __init__(self, task={}, low=0, high=2.0):
        self._task = task
        self.low = low
        self.high = high
    ...
    def step(self, action):
        ...
        Adv = 1.0
        ##print("the value of Adv is", Adv)

        forward_vel = (xposafter - xposbefore) / self.dt
        forward_reward = Adv * -1.0 * abs(forward_vel - self._goal_vel)
        ctrl_cost = Adv * 0.5 * 1e-1 * np.sum(np.square(action))
